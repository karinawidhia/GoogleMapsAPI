 ...
 */
public class FragmentPlace extends Fragment implements OnMapReadyCallback {

    static final CameraPosition swjjr = CameraPosition.builder()
            .target(new LatLng(-7.972649, 112.658601))
            .zoom(15)
            .bearing(0)
            .tilt(45)
            .build();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fragment_place, container, false);
    }
